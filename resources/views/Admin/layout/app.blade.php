    ...
    <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
      ...
      <li class="nav-item">
        ...
        <div id="collapseTwo1" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
          <div class="bg-white py-2 collapse-inner rounded">
            ...
            <a class="collapse-item" href="/admin-setor/create">Create</a>
            <a class="collapse-item" href="/admin-setor">Index</a>
          </div>
        </div>
      </li>
      ...
      <li class="nav-item">
        ...
        <div id="collapseTwo2" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
          <div class="bg-white py-2 collapse-inner rounded">
            <h6 class="collapse-header">Pilih Opsi:</h6>
            <a class="collapse-item" href="/admin-tarik/create">Create</a>
            <a class="collapse-item" href="/admin-tarik">Index</a>
          </div>
        </div>
      </li>
      ...
      <li class="nav-item">
        ...
        <div id="collapseTwo3" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
          <div class="bg-white py-2 collapse-inner rounded">
            <h6 class="collapse-header">Pilih Opsi:</h6>
            <a class="collapse-item" href="/admin-profile/create">Create</a>
            <a class="collapse-item" href="/admin-profile">Index</a>
            <a class="collapse-item" href="/akun">Daftar Akun</a>
          </div>
        </div>
      </li>
      ...
      <li class="nav-item">
        ...
        <div id="collapseTwo4" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
          <div class="bg-white py-2 collapse-inner rounded">
            <h6 class="collapse-header">Pilih Opsi:</h6>
            <a class="collapse-item" href="/tahun_ajaran">Create</a>
          </div>
        </div>
      </li>
      ...
      <li class="nav-item">
        ...
        <div id="collapseTwo5" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
          <div class="bg-white py-2 collapse-inner rounded">
            <h6 class="collapse-header">Pilih Opsi:</h6>
            <a class="collapse-item" href="/admin-rekap/create">Create</a>
            <a class="collapse-item" href="/admin-rekap">Index</a>
          </div>
        </div>
      </li>
